            ...
            <div class="bg-[#202022] dark:bg-[#202022] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    <form action="{{ route('orders.update', $order) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-input-label for="old_order_price" value="السعر القديم" />
                                <input id="old_order_price" name="old_order_price" type="number" step="0.01"
                            ...
                            <div>
                                <x-input-label for="order_price" value="السعر الجديد" />
    ...
    <script>
        ...
        `;
            ...
            function updateCalculations() {
                document.getElementById('old_order_price').value = oldOrderPrice.toFixed(2);
