...
class OrderController extends Controller
{
    ...
    public function edit(Order $order)
    {
        ...
        $shippingRatesData = ShippingRate::where('created_at', '==', $order->created_at)
            ->latest()
            ->first();

        // If no shipping rates found for the order creation date, get the earliest available rates
        if (!$shippingRatesData) {
            $shippingRatesData = ShippingRate::oldest()->first();
        }
